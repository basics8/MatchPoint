...
const AdminOverview = () => {
    ...
    const recentActivity = [
        { id: 1, user: 'Sarah Johnson', action: 'Booked Tennis Court #3', time: '5 min ago', amount: '+$45', initials: 'SJ' },
        { id: 2, user: 'Mike Chen', action: 'Cancelled Badminton Court #1', time: '12 min ago', amount: '-$30', initials: 'MC' },
        { id: 3, user: 'Emma Wilson', action: 'Booked Padel Court #2', time: '23 min ago', amount: '+$60', initials: 'EW' },
        { id: 4, user: 'David Brown', action: 'Booked Tennis Court #1', time: '34 min ago', amount: '+$45', initials: 'DB' },
        { id: 5, user: 'Lisa Anderson', action: 'Booked Badminton Court #4', time: '1 hour ago', amount: '+$30', initials: 'LA' },
        { id: 6, user: 'James Taylor', action: 'Booked Tennis Court #5', time: '2 hours ago', amount: '+$45', initials: 'JT' },
    ];
            ...
            <div className="stats-grid">
                <div className="stats-card">
                    ...
                    <div className="stats-info">
                        ...
                        <h3 className="stats-value">$847,392</h3>
                    </div>
                </div>
                ...
                <div className="chart-container">
                    <svg viewBox={`0 0 ${width} ${height}`} className="line-chart">
                        ...
                        {dataPoints.map((val, i) => {
                            ...
                            const y = height - (val / maxVal) * (height - padding * 2) - padding;
                            return (
                                <circle key={i} cx={x} cy={y} r="4" fill="#111827" stroke="white" strokeWidth="2" />
                            );
                        })}
